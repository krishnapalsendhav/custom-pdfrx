...
class PdfPageText {
  ...
  /// Convert a [PdfPageText] instance to a JSON map.
  ...
  /// Create a [PdfPageText] instance from a JSON map.
  factory PdfPageText.fromJson(Map<String, dynamic> json) {
    return PdfPageText(
      pageNumber: json['pageNumber'],
      fullText: json['fullText'],
      fragments: (json['fragments'] as List).map((f) => PdfPageTextFragment.fromJson(f)).toList(),
    );
  }
}
...
abstract class PdfPageTextFragment {
  ...
  bool operator ==(covariant PdfPageTextFragment other) {
    ...
    return other.index == index && other.bounds == bounds && listEquals(other.charRects, charRects) && other.text == text;
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'charRects': charRects?.map((rect) => rect.toJson()).toList(),
      'text': text,
    };
  }

  /// Create a [PdfPageTextFragment] from JSON.
  static PdfPageTextFragment fromJson(Map<String, dynamic> json) {
    return _PdfPageTextFragment(
      json['index'],
      json['length'],
      PdfRect.fromJson(json['bounds']),
      json['text'] ?? '',
      charRects: (json['charRects'] as List?)?.map((e) => PdfRect.fromJson(e)).toList(),
    );
  }
...
class PdfTextRange {
  ...
  PdfTextRangeWithFragments? toTextRangeWithFragments(PdfPageText pageText) => PdfTextRangeWithFragments.fromTextRange(pageText, start, end);

  /// Convert a [PdfTextRange] instance to a JSON map.
  Map<String, dynamic> toJson() => {
        'start': start,
        'end': end,
      };

  /// Create a [PdfTextRange] instance from a JSON map.
...
class PdfTextRanges {
  ...
  /// Convert a [PdfTextRanges] instance to a JSON map.
  Map<String, dynamic> toJson() => {
        'pageText': pageText.toJson(),
        'ranges': ranges.map((r) => r.toJson()).toList(),
      };

  /// Create a [PdfTextRanges] instance from a JSON map.
  factory PdfTextRanges.fromJson(Map<String, dynamic> json) {
    return PdfTextRanges(
      pageText: PdfPageText.fromJson(json['pageText']),
      ranges: (json['ranges'] as List).map((r) => PdfTextRange.fromJson(r)).toList(),
    );
  }
}
...
class PdfTextRangeWithFragments {
  ...
  @override
  bool operator ==(Object other) {
    return other is PdfTextRangeWithFragments && other.pageNumber == pageNumber && other.start == start && other.end == end && other.bounds == bounds && listEquals(other.fragments, fragments);
  }
}
