...
class PdfDocumentPdfium extends PdfDocument {
  ...
  static Future<PdfDocument> fromPdfDocument(
    ...
    try {
      ...
      pdfDoc = PdfDocumentPdfium._(
        ...
        permissions: result.securityHandlerRevision != -1 ? PdfPermissions(result.permissions, result.securityHandlerRevision) : null,
  ...
  @override
  bool isIdenticalDocumentHandle(Object? other) => other is PdfDocumentPdfium && document.address == other.document.address;
...
class PdfPagePdfium extends PdfPage {
          ...
          return await (await backgroundWorker).compute(
            (params) {
              ...
              try {
                ...
                if (params.formHandle != 0 && params.annotationRenderingMode == PdfAnnotationRenderingMode.annotationAndForms) {
                  pdfium.FPDF_FFLDraw(
  ...
  static pdfium_bindings.FPDF_DEST _processAnnotDest(pdfium_bindings.FPDF_ANNOTATION annot, pdfium_bindings.FPDF_DOCUMENT document, Arena arena) {
  ...
  static Uri? _processAnnotLink(pdfium_bindings.FPDF_ANNOTATION annot, pdfium_bindings.FPDF_DOCUMENT document, Arena arena) {
    final link = pdfium.FPDFAnnot_GetLink(annot);
    final action = pdfium.FPDFLink_GetAction(link);
...
class PdfPageTextFragmentPdfium implements PdfPageTextFragment {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'charRects': charRects?.map((e) => e.toJson()).toList(),
    };
  }
}
...
class PdfPageTextPdfium extends PdfPageText {
  ...
  }) : super(pageNumber: 0, fullText: '', fragments: []);
